...
import {Apple, Bot, LayoutDashboard, MapPin, Settings, Target} from 'lucide-react';
                        ...
                        <div className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-2">
                            <Link to="/chatbot" className="flex items-start p-3 hover:bg-muted rounded-md">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Get health advice from our AI
                                        assistant</p>
                                </div>
                            </Link>
                            <Link to="/settings" className="flex items-start p-3 hover:bg-muted rounded-md">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Configure your application
                                        preferences</p>
                                </div>
                            </Link>
                            <Link to="/api-setup-guide"
                                  className="flex items-start p-3 hover:bg-muted rounded-md lg:col-span-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Learn how to connect to the Django
                                        backend</p>
                                </div>
                            </Link>
                        </div>
